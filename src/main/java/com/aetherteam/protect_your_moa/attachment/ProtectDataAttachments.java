...
public class ProtectDataAttachments {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<MoaArmorAttachment>> MOA_ARMOR = ATTACHMENTS.register("moa_armor", () -> AttachmentType.builder(MoaArmorAttachment::new).serialize(MoaArmorAttachment.CODEC).build());
}
